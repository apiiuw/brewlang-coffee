...
<div class="max-w-2xl mx-auto animate-fade-in-up">
    ...
    <div>
        ...
        <h1 class="font-display mt-2 text-2xl font-black text-stone-50 mb-5 sm:mb-6 sm:text-3xl">Add Menu Item</h1>
    </div>
    ...
    <div class="rounded-2xl border border-stone-800 bg-stone-900 p-4 sm:p-6">
        <form action="{{ route('owner.menus.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <select name="category_id" required class="input-dark !appearance-none cursor-pointer">
            ...
            <div>
                <label class="mb-1.5 block text-xs font-semibold text-stone-500 uppercase tracking-wider">Photo <span class="normal-case text-stone-700">(Optional)</span></label>
